...
public class PrettyPrintVisitor {
  ...
  public static class PrettyPrintVisitorExp implements ExpVisitor<String, RuntimeException> {
  ...
  public static class PrettyPrintVisitorStm implements StmVisitor<String, RuntimeException> {
